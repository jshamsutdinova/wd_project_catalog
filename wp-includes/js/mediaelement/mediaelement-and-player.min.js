...
else{e.enterFullScreen()}}}}});t.exitFullscreenCallback=function(n){var r=n.which||n.keyCode||0;if(t.options.enableKeyboard&&r===27&&(i.HAS_TRUE_NATIVE_FULLSCREEN&&i.IS_FULLSCREEN||t.isFullScreen)){e.exitFullScreen()}};t.globalBind('keydown',t.exitFullscreenCallback);t.normalHeight=0;t.normalWidth=0;if(i.HAS_TRUE_NATIVE_FULLSCREEN){var o=function(){if(e.isFullScreen){if(i.isFullScreen()){e.isNativeFullScreen=!0;e.setControlsSize()}
...
else{var d=e.getElement(e.container).querySelectorAll('embed, object, video'),h=d.length;for(var n=0;n<h;n++){d[n].style.width='100%';d[n].style.height='100%'}};if(e.options.setDimensions&&typeof e.media.setSize==='function'){e.media.setSize(screen.width,screen.height)};var u=e.getElement(e.layers).children,p=u.length;for(var t=0;t<p;t++){u[t].style.width='100%';u[t].style.height='100%'};if(e.fullscreenBtn){(0,r.removeClass)(e.fullscreenBtn,e.options.classPrefix+'fullscreen');(0,r.addClass)(e.fullscreenBtn,e.options.classPrefix+'unfullscreen')};e.setControlsSize();e.isFullScreen=!0;var f=Math.min(screen.width/e.width,screen.height/e.height),o=e.getElement(e.container).querySelector('.'+e.options.classPrefix+'captions-text');if(o){o.style.fontSize=f*100+'%';o.style.lineHeight='normal';e.getElement(e.container).querySelector('.'+e.options.classPrefix+'captions-position').style.bottom=(screen.height-e.normalHeight)/2-e.getElement(e.controls).offsetHeight/2+f+15+'px'};var m=(0,l.createEvent)('enteredfullscreen',e.getElement(e.container));e.getElement(e.container).dispatchEvent(m)},exitFullScreen:function(){var e=this,m=e.media.rendererName!==null&&/(native|html5)/i.test(e.media.rendererName);if(!e.isVideo){return};clearTimeout(e.containerSizeTimeout);if(i.HAS_TRUE_NATIVE_FULLSCREEN&&(i.IS_FULLSCREEN||e.isFullScreen)){i.cancelFullScreen()}(0,r.removeClass)(a.default.documentElement,e.options.classPrefix+'fullscreen');(0,r.removeClass)(e.getElement(e.container),e.options.classPrefix+'container-fullscreen');if(e.options.setDimensions){e.getElement(e.container).style.width=e.normalWidth+'px';e.getElement(e.container).style.height=e.normalHeight+'px';if(m){e.node.style.width=e.normalWidth+'px';e.node.style.height=e.normalHeight+'px'}
...
else{(0,i.removeClass)(l,a.options.classPrefix+'pause');(0,i.removeClass)(l,a.options.classPrefix+'replay');(0,i.addClass)(l,a.options.classPrefix+'play');d.setAttribute('title',f);d.setAttribute('aria-label',f)}};c('pse');r.addEventListener('loadedmetadata',function(){if(r.rendererName.indexOf('flash')===-1){c('pse')}});r.addEventListener('play',function(){c('play')});r.addEventListener('playing',function(){c('play')});r.addEventListener('pause',function(){c('pse')});r.addEventListener('ended',function(){if(!e.options.loop){(0,i.removeClass)(l,a.options.classPrefix+'pause');(0,i.removeClass)(l,a.options.classPrefix+'play');(0,i.addClass)(l,a.options.classPrefix+'replay');d.setAttribute('title',f);d.setAttribute('aria-label',f)}})}})},{'16':16,'2':2,'26':26,'27':27,'5':5}],11:[function(e,t,n){'use strict';var d=e(2),o=a(d),s=e(16),f=a(s),c=e(5),l=a(c),i=e(25),u=e(30),r=e(26);function a(e){return e&&e.__esModule?e:{default:e}};Object.assign(s.config,{enableProgressTooltip:!0,useSmoothHover:!0,forceLive:!1});Object.assign(f.default.prototype,{buildprogress:function(e,n,a,s){var p=0,d=!1,h=!1,t=this,S=e.options.autoRewind,x=e.options.enableProgressTooltip?'<span class="'+t.options.classPrefix+'time-float">'+('<span class="'+t.options.classPrefix+'time-float-current">00:00</span>')+('<span class="'+t.options.classPrefix+'time-float-corner"></span>')+'</span>':'',g=o.default.createElement('div');g.className=t.options.classPrefix+'time-rail';g.innerHTML='<span class="'+t.options.classPrefix+'time-total '+t.options.classPrefix+'time-slider">'+('<span class="'+t.options.classPrefix+'time-buffering"></span>')+('<span class="'+t.options.classPrefix+'time-loaded"></span>')+('<span class="'+t.options.classPrefix+'time-current"></span>')+('<span class="'+t.options.classPrefix+'time-hovered no-hover"></span>')+('<span class="'+t.options.classPrefix+'time-handle"><span class="'+t.options.classPrefix+'time-handle-content"></span></span>')+(''+x)+'</span>';t.addControlElement(g,'progress');t.options.keyActions.push({keys:[37,227],action:function(e){if(!isNaN(e.duration)&&e.duration>0){if(e.isVideo){e.showControls();e.startControlsTimer()};var n=e.getElement(e.container).querySelector('.'+t.options.classPrefix+'time-total');if(n){n.focus()};var i=Math.max(e.currentTime-e.options.defaultSeekBackwardInterval(e),0);if(!e.paused){e.pause()};setTimeout(function(){e.setCurrentTime(i)},0);setTimeout(function(){e.play()},0)}}},{keys:[39,228],action:function(e){if(!isNaN(e.duration)&&e.duration>0){if(e.isVideo){e.showControls();e.startControlsTimer()};var n=e.getElement(e.container).querySelector('.'+t.options.classPrefix+'time-total');if(n){n.focus()};var i=Math.min(e.currentTime+e.options.defaultSeekForwardInterval(e),e.duration);if(!e.paused){e.pause()};setTimeout(function(){e.setCurrentTime(i)},0);setTimeout(function(){e.play()},0)}}});t.rail=n.querySelector('.'+t.options.classPrefix+'time-rail');t.total=n.querySelector('.'+t.options.classPrefix+'time-total');t.loaded=n.querySelector('.'+t.options.classPrefix+'time-loaded');t.current=n.querySelector('.'+t.options.classPrefix+'time-current');t.handle=n.querySelector('.'+t.options.classPrefix+'time-handle');t.timefloat=n.querySelector('.'+t.options.classPrefix+'time-float');t.timefloatcurrent=n.querySelector('.'+t.options.classPrefix+'time-float-current');t.slider=n.querySelector('.'+t.options.classPrefix+'time-slider');t.hovered=n.querySelector('.'+t.options.classPrefix+'time-hovered');t.buffer=n.querySelector('.'+t.options.classPrefix+'time-buffering');t.newTime=0;t.forcedHandlePause=!1;t.setTransformStyle=function(e,t){e.style.transform=t;e.style.webkitTransform=t;e.style.MozTransform=t;e.style.msTransform=t;e.style.OTransform=t};t.buffer.style.display='none';var m=function(n){var f=getComputedStyle(t.total),l=(0,r.offset)(t.total),c=t.total.offsetWidth,S=function(){if(f.webkitTransform!==undefined){return'webkitTransform'}
else if(f.mozTransform!==undefined){return'mozTransform '}
else if(f.oTransform!==undefined){return'oTransform'}
else if(f.msTransform!==undefined){return'msTransform'}
...
else if('CSSMatrix' in window){return'CSSMatrix'}}(),y=0,o=0,s=0,a=void 0;if(n.originalEvent&&n.originalEvent.changedTouches){a=n.originalEvent.changedTouches[0].pageX}
else if(n.changedTouches){a=n.changedTouches[0].pageX}
else{a=n.pageX};if(t.getDuration()){if(a<l.left){a=l.left}
else if(a>c+l.left){a=c+l.left};s=a-l.left;y=s/c;t.newTime=y*t.getDuration();if(d&&t.getCurrentTime()!==null&&t.newTime.toFixed(4)!==t.getCurrentTime().toFixed(4)){t.setCurrentRailHandle(t.newTime);t.updateCurrent(t.newTime)};if(!i.IS_IOS&&!i.IS_ANDROID){if(s<0){s=0};if(t.options.useSmoothHover&&p!==null&&typeof window[p]!=='undefined'){var b=new window[p](getComputedStyle(t.handle)[S]),g=b.m41,v=s/parseFloat(getComputedStyle(t.total).width)-g/parseFloat(getComputedStyle(t.total).width);t.hovered.style.left=g+'px';t.setTransformStyle(t.hovered,'scaleX('+v+')');t.hovered.setAttribute('pos',s);if(v>=0){(0,r.removeClass)(t.hovered,'negative')}
...
else if(!i.IS_IOS&&!i.IS_ANDROID&&t.timefloat){o=t.timefloat.offsetWidth+c>=t.getElement(t.container).offsetWidth?t.timefloat.offsetWidth/2:0;t.timefloat.style.left=o+'px';t.timefloat.style.left=o+'px';t.timefloat.style.display='block'}},y=function(){var n=t.getCurrentTime(),r=l.default.t('mejs.time-slider'),a=(0,u.secondsToTimeCode)(n,e.options.alwaysShowHours,e.options.showTimecodeFrameCount,e.options.framesPerSecond,e.options.secondsDecimalLength,e.options.timeFormat),i=t.getDuration();t.slider.setAttribute('role','slider');t.slider.tabIndex=0;if(s.paused){t.slider.setAttribute('aria-label',r);t.slider.setAttribute('aria-valuemin',0);t.slider.setAttribute('aria-valuemax',isNaN(i)?0:i);t.slider.setAttribute('aria-valuenow',n);t.slider.setAttribute('aria-valuetext',a)}
else{t.slider.removeAttribute('aria-label');t.slider.removeAttribute('aria-valuemin');t.slider.removeAttribute('aria-valuemax');t.slider.removeAttribute('aria-valuenow');t.slider.removeAttribute('aria-valuetext')}},E=function(){if(new Date()-p>=1000){t.play()}},b=function(){if(d&&t.getCurrentTime()!==null&&t.newTime.toFixed(4)!==t.getCurrentTime().toFixed(4)){t.setCurrentTime(t.newTime);t.setCurrentRailHandle(t.newTime);t.updateCurrent(t.newTime)};if(t.forcedHandlePause){t.slider.focus();t.play()};t.forcedHandlePause=!1};t.slider.addEventListener('focus',function(){e.options.autoRewind=!1});t.slider.addEventListener('blur',function(){e.options.autoRewind=S});t.slider.addEventListener('keydown',function(n){if(new Date()-p>=1000){h=t.paused};if(t.options.enableKeyboard&&t.options.keyActions.length){var a=n.which||n.keyCode||0,l=t.getDuration(),f=e.options.defaultSeekForwardInterval(s),c=e.options.defaultSeekBackwardInterval(s),r=t.getCurrentTime(),o=t.getElement(t.container).querySelector('.'+t.options.classPrefix+'volume-slider');if(a===38||a===40){if(o){o.style.display='block'};if(t.isVideo){t.showControls();t.startControlsTimer()};var u=a===38?Math.min(t.volume+0.1,1):Math.max(t.volume-0.1,0),d=u<=0;t.setVolume(u);t.setMuted(d);return}
else{if(o){o.style.display='none'}};switch(a){case 37:if(t.getDuration()!==Infinity){r-=c};break;case 39:if(t.getDuration()!==Infinity){r+=f};break;case 36:r=0;break;case 35:r=l;break;case 13:case 32:if(i.IS_FIREFOX){if(t.paused){t.play()}
else{t.pause()}};return;default:return};r=r<0||isNaN(r)?0:r>=l?l:Math.floor(r);p=new Date();if(!h){e.pause()};setTimeout(function(){t.setCurrentTime(r)},0);if(r<t.getDuration()&&!h){setTimeout(E,1100)};e.showControls();n.preventDefault();n.stopPropagation()}});var c=['mousedown','touchstart'];t.slider.addEventListener('dragstart',function(){return!1});for(var f=0,v=c.length;f<v;f++){t.slider.addEventListener(c[f],function(e){t.forcedHandlePause=!1;if(t.getDuration()!==Infinity){if(e.which===1||e.which===0){if(!t.paused){t.pause();t.forcedHandlePause=!0};d=!0;m(e);var i=['mouseup','touchend'];for(var n=0,r=i.length;n<r;n++){t.getElement(t.container).addEventListener(i[n],function(e){var n=e.target;if(n===t.slider||n.closest('.'+t.options.classPrefix+'time-slider')){m(e)}})};t.globalBind('mouseup.dur touchend.dur',function(){b();d=!1;if(t.timefloat){t.timefloat.style.display='none'}})}}},i.SUPPORT_PASSIVE_EVENT&&c[f]==='touchstart'?{passive:!0}:!1)};t.slider.addEventListener('mouseenter',function(e){if(e.target===t.slider&&t.getDuration()!==Infinity){t.getElement(t.container).addEventListener('mousemove',function(e){var n=e.target;if(n===t.slider||n.closest('.'+t.options.classPrefix+'time-slider')){m(e)}});if(t.timefloat&&!i.IS_IOS&&!i.IS_ANDROID){t.timefloat.style.display='block'};if(t.hovered&&!i.IS_IOS&&!i.IS_ANDROID&&t.options.useSmoothHover){(0,r.removeClass)(t.hovered,'no-hover')}}});t.slider.addEventListener('mouseleave',function(){if(t.getDuration()!==Infinity){if(!d){if(t.timefloat){t.timefloat.style.display='none'};if(t.hovered&&t.options.useSmoothHover){(0,r.addClass)(t.hovered,'no-hover')}}}});t.broadcastCallback=function(i){var a=n.querySelector('.'+t.options.classPrefix+'broadcast');if(!t.options.forceLive&&t.getDuration()!==Infinity){if(a){t.slider.style.display='';a.remove()};e.setProgressRail(i);if(!t.forcedHandlePause){e.setCurrentRail(i)};y()}
else if(!a&&t.options.forceLive){var r=o.default.createElement('span');r.className=t.options.classPrefix+'broadcast';r.innerText=l.default.t('mejs.live-broadcast');t.slider.style.display='none';t.rail.appendChild(r)}};s.addEventListener('progress',t.broadcastCallback);s.addEventListener('timeupdate',t.broadcastCallback);s.addEventListener('play',function(){t.buffer.style.display='none'});s.addEventListener('playing',function(){t.buffer.style.display='none'});s.addEventListener('seeking',function(){t.buffer.style.display=''});s.addEventListener('seeked',function(){t.buffer.style.display='none'});s.addEventListener('pause',function(){t.buffer.style.display='none'});s.addEventListener('waiting',function(){t.buffer.style.display=''});s.addEventListener('loadeddata',function(){t.buffer.style.display=''});s.addEventListener('canplay',function(){t.buffer.style.display='none'});s.addEventListener('error',function(){t.buffer.style.display='none'});t.getElement(t.container).addEventListener('controlsresize',function(n){if(t.getDuration()!==Infinity){e.setProgressRail(n);if(!t.forcedHandlePause){e.setCurrentRail(n)}}})},cleanprogress:function(e,t,n,i){i.removeEventListener('progress',e.broadcastCallback);i.removeEventListener('timeupdate',e.broadcastCallback);if(e.rail){e.rail.remove()}},setProgressRail:function(e){var i=this,t=e!==undefined?e.detail.target||e.target:i.media,n=null;if(t&&t.buffered&&t.buffered.length>0&&t.buffered.end&&i.getDuration()){n=t.buffered.end(t.buffered.length-1)/i.getDuration()}
...
else if(i>t){a=n-1}};return-1}});o.default.language={codes:{af:'mejs.afrikaans',sq:'mejs.albanian',ar:'mejs.arabic',be:'mejs.belarusian',bg:'mejs.bulgarian',ca:'mejs.catalan',zh:'mejs.chinese','zh-cn':'mejs.chinese-simplified','zh-tw':'mejs.chines-traditional',hr:'mejs.croatian',cs:'mejs.czech',da:'mejs.danish',nl:'mejs.dutch',en:'mejs.english',et:'mejs.estonian',fl:'mejs.filipino',fi:'mejs.finnish',fr:'mejs.french',gl:'mejs.galician',de:'mejs.german',el:'mejs.greek',ht:'mejs.haitian-creole',iw:'mejs.hebrew',hi:'mejs.hindi',hu:'mejs.hungarian',is:'mejs.icelandic',id:'mejs.indonesian',ga:'mejs.irish',it:'mejs.italian',ja:'mejs.japanese',ko:'mejs.korean',lv:'mejs.latvian',lt:'mejs.lithuanian',mk:'mejs.macedonian',ms:'mejs.malay',mt:'mejs.maltese',no:'mejs.norwegian',fa:'mejs.persian',pl:'mejs.polish',pt:'mejs.portuguese',ro:'mejs.romanian',ru:'mejs.russian',sr:'mejs.serbian',sk:'mejs.slovak',sl:'mejs.slovenian',es:'mejs.spanish',sw:'mejs.swahili',sv:'mejs.swedish',tl:'mejs.tagalog',th:'mejs.thai',tr:'mejs.turkish',uk:'mejs.ukrainian',vi:'mejs.vietnamese',cy:'mejs.welsh',yi:'mejs.yiddish'}};o.default.TrackFormatParser={webvtt:{pattern:/^((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{1,3})?) --\> ((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{3})?)(.*)$/,parse:function(e){var n=e.split(/\r?\n/),s=[],r=void 0,i=void 0,o=void 0;for(var t=0,l=n.length;t<l;t++){r=this.pattern.exec(n[t]);if(r&&t<n.length){if(t-1>=0&&n[t-1]!==''){o=n[t-1]};t++;i=n[t];t++;while(n[t]!==''&&t<n.length){i=i+'\n'+n[t];t++};i=i===null?'':i.trim().replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig,'<a href=\'$1\' target=\'_blank\'>$1</a>');s.push({identifier:o,start:(0,a.convertSMPTEtoSeconds)(r[1])===0?0.200:(0,a.convertSMPTEtoSeconds)(r[1]),stop:(0,a.convertSMPTEtoSeconds)(r[3]),text:i,settings:r[5]})};o=''};return s}},dfxp:{parse:function(e){e=$(e).filter('tt');var f=e.firstChild,i=f.querySelectorAll('p'),u=e.getElementById(''+f.attr('style')),c=[],r=void 0;if(u.length){u.removeAttribute('id');var l=u.attributes;if(l.length){r={};for(var s=0,p=l.length;s<p;s++){r[l[s].name.split(':')[1]]=l[s].value}}};for(var n=0,m=i.length;n<m;n++){var o=void 0,t={start:null,stop:null,style:null,text:null};if(i.eq(n).attr('begin')){t.start=(0,a.convertSMPTEtoSeconds)(i.eq(n).attr('begin'))};if(!t.start&&i.eq(n-1).attr('end')){t.start=(0,a.convertSMPTEtoSeconds)(i.eq(n-1).attr('end'))};if(i.eq(n).attr('end')){t.stop=(0,a.convertSMPTEtoSeconds)(i.eq(n).attr('end'))};if(!t.stop&&i.eq(n+1).attr('begin')){t.stop=(0,a.convertSMPTEtoSeconds)(i.eq(n+1).attr('begin'))};if(r){o='';for(var d in r){o+=d+':'+r[d]+';'}};if(o){t.style=o};if(t.start===0){t.start=0.200};t.text=i.eq(n).innerHTML.trim().replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig,'<a href=\'$1\' target=\'_blank\'>$1</a>');c.push(t)};return c}}}},{'16':16,'2':2,'26':26,'27':27,'30':30,'5':5,'7':7}],14:[function(e,t,n){'use strict';var d=e(2),s=o(d),l=e(16),f=o(l),c=e(5),r=o(c),u=e(25),a=e(27),i=e(26);function o(e){return e&&e.__esModule?e:{default:e}};Object.assign(l.config,{muteText:null,unmuteText:null,allyVolumeControlText:null,hideVolumeOnTouchDevices:!0,audioVolume:'horizontal',videoVolume:'vertical',startVolume:0.8});Object.assign(f.default.prototype,{buildvolume:function(e,t,o,l){if((u.IS_ANDROID||u.IS_IOS)&&this.options.hideVolumeOnTouchDevices){return};var n=this,c=n.isVideo?n.options.videoVolume:n.options.audioVolume,g=(0,a.isString)(n.options.muteText)?n.options.muteText:r.default.t('mejs.mute'),T=(0,a.isString)(n.options.unmuteText)?n.options.unmuteText:r.default.t('mejs.unmute'),k=(0,a.isString)(n.options.allyVolumeControlText)?n.options.allyVolumeControlText:r.default.t('mejs.volume-help-text'),d=s.default.createElement('div');d.className=n.options.classPrefix+'button '+n.options.classPrefix+'volume-button '+n.options.classPrefix+'mute';d.innerHTML=c==='horizontal'?'<button type="button" aria-controls="'+n.id+'" title="'+g+'" aria-label="'+g+'" tabindex="0"></button>':'<button type="button" aria-controls="'+n.id+'" title="'+g+'" aria-label="'+g+'" tabindex="0"></button>'+('<a href="javascript:void(0);" class="'+n.options.classPrefix+'volume-slider" ')+('aria-label="'+r.default.t('mejs.volume-slider')+'" aria-valuemin="0" aria-valuemax="100" role="slider" ')+'aria-orientation="vertical">'+('<span class="'+n.options.classPrefix+'offscreen">'+k+'</span>')+('<div class="'+n.options.classPrefix+'volume-total">')+('<div class="'+n.options.classPrefix+'volume-current"></div>')+('<div class="'+n.options.classPrefix+'volume-handle"></div>')+'</div></a>';n.addControlElement(d,'volume');n.options.keyActions.push({keys:[38],action:function(e){var t=e.getElement(e.container).querySelector('.'+n.options.classPrefix+'volume-slider');if(t&&t.matches(':focus')){t.style.display='block'};if(e.isVideo){e.showControls();e.startControlsTimer()};var i=Math.min(e.volume+0.1,1);e.setVolume(i);if(i>0){e.setMuted(!1)}}},{keys:[40],action:function(e){var i=e.getElement(e.container).querySelector('.'+n.options.classPrefix+'volume-slider');if(i){i.style.display='block'};if(e.isVideo){e.showControls();e.startControlsTimer()};var t=Math.max(e.volume-0.1,0);e.setVolume(t);if(t<=0.1){e.setMuted(!0)}}},{keys:[77],action:function(e){var t=e.getElement(e.container).querySelector('.'+n.options.classPrefix+'volume-slider');if(t){t.style.display='block'};if(e.isVideo){e.showControls();e.startControlsTimer()};if(e.media.muted){e.setMuted(!1)}
else{e.setMuted(!0)}}});if(c==='horizontal'){var m=s.default.createElement('a');m.className=n.options.classPrefix+'horizontal-volume-slider';m.href='javascript:void(0);';m.setAttribute('aria-label',r.default.t('mejs.volume-slider'));m.setAttribute('aria-valuemin',0);m.setAttribute('aria-valuemax',100);m.setAttribute('aria-valuenow',100);m.setAttribute('role','slider');m.innerHTML+='<span class="'+n.options.classPrefix+'offscreen">'+k+'</span>'+('<div class="'+n.options.classPrefix+'horizontal-volume-total">')+('<div class="'+n.options.classPrefix+'horizontal-volume-current"></div>')+('<div class="'+n.options.classPrefix+'horizontal-volume-handle"></div>')+'</div>';d.parentNode.insertBefore(m,d.nextSibling)};var h=!1,p=!1,S=!1,C=function(){var e=Math.floor(l.volume*100);f.setAttribute('aria-valuenow',e);f.setAttribute('aria-valuetext',e+'%')},f=c==='vertical'?n.getElement(n.container).querySelector('.'+n.options.classPrefix+'volume-slider'):n.getElement(n.container).querySelector('.'+n.options.classPrefix+'horizontal-volume-slider'),w=c==='vertical'?n.getElement(n.container).querySelector('.'+n.options.classPrefix+'volume-total'):n.getElement(n.container).querySelector('.'+n.options.classPrefix+'horizontal-volume-total'),y=c==='vertical'?n.getElement(n.container).querySelector('.'+n.options.classPrefix+'volume-current'):n.getElement(n.container).querySelector('.'+n.options.classPrefix+'horizontal-volume-current'),v=c==='vertical'?n.getElement(n.container).querySelector('.'+n.options.classPrefix+'volume-handle'):n.getElement(n.container).querySelector('.'+n.options.classPrefix+'horizontal-volume-handle'),E=function(e){if(e===null||isNaN(e)||e===undefined){return};e=Math.max(0,e);e=Math.min(e,1);if(e===0){(0,i.removeClass)(d,n.options.classPrefix+'mute');(0,i.addClass)(d,n.options.classPrefix+'unmute');var o=d.firstElementChild;o.setAttribute('title',T);o.setAttribute('aria-label',T)}
else{(0,i.removeClass)(d,n.options.classPrefix+'unmute');(0,i.addClass)(d,n.options.classPrefix+'mute');var a=d.firstElementChild;a.setAttribute('title',g);a.setAttribute('aria-label',g)};var t=e*100+'%',r=getComputedStyle(v);if(c==='vertical'){y.style.bottom=0;y.style.height=t;v.style.bottom=t;v.style.marginBottom=-parseFloat(r.height)/2+'px'}
else{y.style.left=0;y.style.width=t;v.style.left=t;v.style.marginLeft=-parseFloat(r.width)/2+'px'}},P=function(e){var r=(0,i.offset)(w),o=getComputedStyle(w);S=!0;var t=null;if(c==='vertical'){var a=parseFloat(o.height),u=e.pageY-r.top;t=(a-u)/a;if(r.top===0||r.left===0){return}}
else{var s=parseFloat(o.width),l=e.pageX-r.left;t=l/s};t=Math.max(0,t);t=Math.min(t,1);E(t);n.setMuted(t===0);n.setVolume(t);e.preventDefault();e.stopPropagation()},x=function(){if(n.muted){E(0);(0,i.removeClass)(d,n.options.classPrefix+'mute');(0,i.addClass)(d,n.options.classPrefix+'unmute')}
else{E(l.volume);(0,i.removeClass)(d,n.options.classPrefix+'unmute');(0,i.addClass)(d,n.options.classPrefix+'mute')}};e.getElement(e.container).addEventListener('keydown',function(e){var t=!!e.target.closest('.'+n.options.classPrefix+'container');if(!t&&c==='vertical'){f.style.display='none'}});d.addEventListener('mouseenter',function(e){if(e.target===d){f.style.display='block';p=!0;e.preventDefault();e.stopPropagation()}});d.addEventListener('focusin',function(){f.style.display='block';p=!0});d.addEventListener('focusout',function(e){if((!e.relatedTarget||e.relatedTarget&&!e.relatedTarget.matches('.'+n.options.classPrefix+'volume-slider'))&&c==='vertical'){f.style.display='none'}});d.addEventListener('mouseleave',function(){p=!1;if(!h&&c==='vertical'){f.style.display='none'}});d.addEventListener('focusout',function(){p=!1});d.addEventListener('keydown',function(e){if(n.options.enableKeyboard&&n.options.keyActions.length){var i=e.which||e.keyCode||0,t=l.volume;switch(i){case 38:t=Math.min(t+0.1,1);break;case 40:t=Math.max(0,t-0.1);break;default:return!0};h=!1;E(t);l.setVolume(t);e.preventDefault();e.stopPropagation()}});d.querySelector('button').addEventListener('click',function(){l.setMuted(!l.muted);var e=(0,a.createEvent)('volumechange',l);l.dispatchEvent(e)});f.addEventListener('dragstart',function(){return!1});f.addEventListener('mouseover',function(){p=!0});f.addEventListener('focusin',function(){f.style.display='block';p=!0});f.addEventListener('focusout',function(){p=!1;if(!h&&c==='vertical'){f.style.display='none'}});f.addEventListener('mousedown',function(e){P(e);n.globalBind('mousemove.vol',function(e){var t=e.target;if(h&&(t===f||t.closest(c==='vertical'?'.'+n.options.classPrefix+'volume-slider':'.'+n.options.classPrefix+'horizontal-volume-slider'))){P(e)}});n.globalBind('mouseup.vol',function(){h=!1;if(!p&&c==='vertical'){f.style.display='none'}});h=!0;e.preventDefault();e.stopPropagation()});l.addEventListener('volumechange',function(e){if(!h){x()};C(e)});var b=!1;l.addEventListener('rendererready',function(){if(!S){setTimeout(function(){b=!0;if(e.options.startVolume===0||l.originalNode.muted){l.setMuted(!0);e.options.startVolume=0};l.setVolume(e.options.startVolume);n.setControlsSize()},250)}});l.addEventListener('loadedmetadata',function(){setTimeout(function(){if(!S&&!b){if(e.options.startVolume===0||l.originalNode.muted){l.setMuted(!0)};l.setVolume(e.options.startVolume);n.setControlsSize()};b=!1},250)});if(e.options.startVolume===0||l.originalNode.muted){l.setMuted(!0);e.options.startVolume=0;x()};n.getElement(n.container).addEventListener('controlsresize',function(){x()})}})},{'16':16,'2':2,'25':25,'26':26,'27':27,'5':5}],15:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});var i=n.EN={'mejs.plural-form':1,'mejs.download-file':'Download File','mejs.install-flash':'You are using a browser that does not have Flash player enabled or installed. Please turn on your Flash player plugin or download the latest version from https://get.adobe.com/flashplayer/','mejs.fullscreen':'Fullscreen','mejs.play':'Play','mejs.pause':'Pause','mejs.time-slider':'Time Slider','mejs.time-help-text':'Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.','mejs.live-broadcast':'Live Broadcast','mejs.volume-help-text':'Use Up/Down Arrow keys to increase or decrease volume.','mejs.unmute':'Unmute','mejs.mute':'Mute','mejs.volume-slider':'Volume Slider','mejs.video-player':'Video Player','mejs.audio-player':'Audio Player','mejs.captions-subtitles':'Captions/Subtitles','mejs.captions-chapters':'Chapters','mejs.none':'None','mejs.afrikaans':'Afrikaans','mejs.albanian':'Albanian','mejs.arabic':'Arabic','mejs.belarusian':'Belarusian','mejs.bulgarian':'Bulgarian','mejs.catalan':'Catalan','mejs.chinese':'Chinese','mejs.chinese-simplified':'Chinese (Simplified)','mejs.chinese-traditional':'Chinese (Traditional)','mejs.croatian':'Croatian','mejs.czech':'Czech','mejs.danish':'Danish','mejs.dutch':'Dutch','mejs.english':'English','mejs.estonian':'Estonian','mejs.filipino':'Filipino','mejs.finnish':'Finnish','mejs.french':'French','mejs.galician':'Galician','mejs.german':'German','mejs.greek':'Greek','mejs.haitian-creole':'Haitian Creole','mejs.hebrew':'Hebrew','mejs.hindi':'Hindi','mejs.hungarian':'Hungarian','mejs.icelandic':'Icelandic','mejs.indonesian':'Indonesian','mejs.irish':'Irish','mejs.italian':'Italian','mejs.japanese':'Japanese','mejs.korean':'Korean','mejs.latvian':'Latvian','mejs.lithuanian':'Lithuanian','mejs.macedonian':'Macedonian','mejs.malay':'Malay','mejs.maltese':'Maltese','mejs.norwegian':'Norwegian','mejs.persian':'Persian','mejs.polish':'Polish','mejs.portuguese':'Portuguese','mejs.romanian':'Romanian','mejs.russian':'Russian','mejs.serbian':'Serbian','mejs.slovak':'Slovak','mejs.slovenian':'Slovenian','mejs.spanish':'Spanish','mejs.swahili':'Swahili','mejs.swedish':'Swedish','mejs.tagalog':'Tagalog','mejs.thai':'Thai','mejs.turkish':'Turkish','mejs.ukrainian':'Ukrainian','mejs.vietnamese':'Vietnamese','mejs.welsh':'Welsh','mejs.yiddish':'Yiddish'}},{}],16:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});n.config=undefined;var p=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(e){return typeof e}:function(e){return e&&typeof Symbol==='function'&&e.constructor===Symbol&&e!==Symbol.prototype?'symbol':typeof e},h=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1;n.configurable=!0;if('value' in n)n.writable=!0;Object.defineProperty(e,n.key,n)}};return function(t,n,i){if(n)e(t.prototype,n);if(i)e(t,i);return t}}(),g=e(3),o=u(g),v=e(2),r=u(v),y=e(7),s=u(y),E=e(6),b=u(E),S=e(17),x=u(S),w=e(5),f=u(w),i=e(25),l=e(27),c=e(30),P=e(28),T=e(26),a=k(T);function k(e){if(e&&e.__esModule){return e}
else{var n={};if(e!=null){for(var t in e){if(Object.prototype.hasOwnProperty.call(e,t))n[t]=e[t]}};n.default=e;return n}};function u(e){return e&&e.__esModule?e:{default:e}};function C(e,t){if(!(e instanceof t)){throw new TypeError('Cannot call a class as a function')}};s.default.mepIndex=0;s.default.players={};var m=n.config={poster:'',showPosterWhenEnded:!1,showPosterWhenPaused:!1,defaultVideoWidth:480,defaultVideoHeight:270,videoWidth:-1,videoHeight:-1,defaultAudioWidth:400,defaultAudioHeight:40,defaultSeekBackwardInterval:function(e){return e.getDuration()*0.05},defaultSeekForwardInterval:function(e){return e.getDuration()*0.05},setDimensions:!0,audioWidth:-1,audioHeight:-1,loop:!1,autoRewind:!0,enableAutosize:!0,timeFormat:'',alwaysShowHours:!1,showTimecodeFrameCount:!1,framesPerSecond:25,alwaysShowControls:!1,hideVideoControlsOnLoad:!1,hideVideoControlsOnPause:!1,clickToPlayPause:!0,controlsTimeoutDefault:1500,controlsTimeoutMouseEnter:2500,controlsTimeoutMouseLeave:1000,iPadUseNativeControls:!1,iPhoneUseNativeControls:!1,AndroidUseNativeControls:!1,features:['playpause','current','progress','duration','tracks','volume','fullscreen'],useDefaultControls:!1,isVideo:!0,stretching:'auto',classPrefix:'mejs__',enableKeyboard:!0,pauseOtherPlayers:!0,secondsDecimalLength:0,customError:null,keyActions:[{keys:[32,179],action:function(e){if(!i.IS_FIREFOX){if(e.paused||e.ended){e.play()}
else{e.pause()}}}}]};s.default.MepDefaults=m;var d=function(){function e(t,n){C(this,e);var i=this,o=typeof t==='string'?r.default.getElementById(t):t;if(!(i instanceof e)){return new e(o,n)};i.node=i.media=o;if(!i.node){return};if(i.media.player){return i.media.player};i.hasFocus=!1;i.controlsAreVisible=!0;i.controlsEnabled=!0;i.controlsTimer=null;i.currentMediaTime=0;i.proxy=null;if(n===undefined){var a=i.node.getAttribute('data-mejsoptions');n=a?JSON.parse(a):{}};i.options=Object.assign({},m,n);if(i.options.loop&&!i.media.getAttribute('loop')){i.media.loop=!0;i.node.loop=!0}
else if(i.media.loop){i.options.loop=!0};if(!i.options.timeFormat){i.options.timeFormat='mm:ss';if(i.options.alwaysShowHours){i.options.timeFormat='hh:mm:ss'};if(i.options.showTimecodeFrameCount){i.options.timeFormat+=':ff'}}(0,c.calculateTimeFormat)(0,i.options,i.options.framesPerSecond||25);i.id='mep_'+s.default.mepIndex++;s.default.players[i.id]=i;i.init();return i};h(e,[{key:'getElement',value:function(e){return e}},{key:'init',value:function(){var e=this,n=Object.assign({},e.options,{success:function(t,n){e._meReady(t,n)},error:function(t){e._handleError(t)}}),o=e.node.tagName.toLowerCase();e.isDynamic=o!=='audio'&&o!=='video'&&o!=='iframe';e.isVideo=e.isDynamic?e.options.isVideo:o!=='audio'&&e.options.isVideo;e.mediaFiles=null;e.trackFiles=null;if(i.IS_IPAD&&e.options.iPadUseNativeControls||i.IS_IPHONE&&e.options.iPhoneUseNativeControls){e.node.setAttribute('controls',!0);if(i.IS_IPAD&&e.node.getAttribute('autoplay')){e.play()}}
else if((e.isVideo||!e.isVideo&&(e.options.features.length||e.options.useDefaultControls))&&!(i.IS_ANDROID&&e.options.AndroidUseNativeControls)){e.node.removeAttribute('controls');var m=e.isVideo?f.default.t('mejs.video-player'):f.default.t('mejs.audio-player'),d=r.default.createElement('span');d.className=e.options.classPrefix+'offscreen';d.innerText=m;e.media.parentNode.insertBefore(d,e.media);e.container=r.default.createElement('div');e.getElement(e.container).id=e.id;e.getElement(e.container).className=e.options.classPrefix+'container '+e.options.classPrefix+'container-keyboard-inactive '+e.media.className;e.getElement(e.container).tabIndex=0;e.getElement(e.container).setAttribute('role','application');e.getElement(e.container).setAttribute('aria-label',m);e.getElement(e.container).innerHTML='<div class="'+e.options.classPrefix+'inner">'+('<div class="'+e.options.classPrefix+'mediaelement"></div>')+('<div class="'+e.options.classPrefix+'layers"></div>')+('<div class="'+e.options.classPrefix+'controls"></div>')+'</div>';e.getElement(e.container).addEventListener('focus',function(t){if(!e.controlsAreVisible&&!e.hasFocus&&e.controlsEnabled){e.showControls(!0);var n=(0,l.isNodeAfter)(t.relatedTarget,e.getElement(e.container))?'.'+e.options.classPrefix+'controls .'+e.options.classPrefix+'button:last-child > button':'.'+e.options.classPrefix+'playpause-button > button',i=e.getElement(e.container).querySelector(n);i.focus()}});e.node.parentNode.insertBefore(e.getElement(e.container),e.node);if(!e.options.features.length&&!e.options.useDefaultControls){e.getElement(e.container).style.background='transparent';e.getElement(e.container).querySelector('.'+e.options.classPrefix+'controls').style.display='none'};if(e.isVideo&&e.options.stretching==='fill'&&!a.hasClass(e.getElement(e.container).parentNode,e.options.classPrefix+'fill-container')){e.outerContainer=e.media.parentNode;var u=r.default.createElement('div');u.className=e.options.classPrefix+'fill-container';e.getElement(e.container).parentNode.insertBefore(u,e.getElement(e.container));u.appendChild(e.getElement(e.container))};if(i.IS_ANDROID){a.addClass(e.getElement(e.container),e.options.classPrefix+'android')};if(i.IS_IOS){a.addClass(e.getElement(e.container),e.options.classPrefix+'ios')};if(i.IS_IPAD){a.addClass(e.getElement(e.container),e.options.classPrefix+'ipad')};if(i.IS_IPHONE){a.addClass(e.getElement(e.container),e.options.classPrefix+'iphone')};a.addClass(e.getElement(e.container),e.isVideo?e.options.classPrefix+'video':e.options.classPrefix+'audio');e.getElement(e.container).querySelector('.'+e.options.classPrefix+'mediaelement').appendChild(e.node);e.media.player=e;e.controls=e.getElement(e.container).querySelector('.'+e.options.classPrefix+'controls');e.layers=e.getElement(e.container).querySelector('.'+e.options.classPrefix+'layers');var t=e.isVideo?'video':'audio',c=t.substring(0,1).toUpperCase()+t.substring(1);if(e.options[t+'Width']>0||e.options[t+'Width'].toString().indexOf('%')>-1){e.width=e.options[t+'Width']}
...
else{e.width=e.options['default'+c+'Width']};if(e.options[t+'Height']>0||e.options[t+'Height'].toString().indexOf('%')>-1){e.height=e.options[t+'Height']}
...
else{e.height=e.options['default'+c+'Height']};e.initialAspectRatio=e.height>=e.width?e.width/e.height:e.height/e.width;e.setPlayerSize(e.width,e.height);n.pluginWidth=e.width;n.pluginHeight=e.height}
else if(!e.isVideo&&!e.options.features.length&&!e.options.useDefaultControls){e.node.style.display='none'};s.default.MepDefaults=n;new b.default(e.media,n,e.mediaFiles);if(e.getElement(e.container)!==undefined&&e.options.features.length&&e.controlsAreVisible&&!e.options.hideVideoControlsOnLoad){var p=(0,l.createEvent)('controlsshown',e.getElement(e.container));e.getElement(e.container).dispatchEvent(p)}}},{key:'showControls',value:function(e){var t=this;e=e===undefined||e;if(t.controlsAreVisible||!t.isVideo){return};if(e){(function(){a.fadeIn(t.getElement(t.controls),200,function(){a.removeClass(t.getElement(t.controls),t.options.classPrefix+'offscreen');var e=(0,l.createEvent)('controlsshown',t.getElement(t.container));t.getElement(t.container).dispatchEvent(e)});var n=t.getElement(t.container).querySelectorAll('.'+t.options.classPrefix+'control'),r=function(e,i){a.fadeIn(n[e],200,function(){a.removeClass(n[e],t.options.classPrefix+'offscreen')})};for(var e=0,i=n.length;e<i;e++){r(e,i)}})()}
...
else{i='auto'};e.node.style.width=n;e.node.style.height=i;e.setPlayerSize(0,0);if(!e.isDynamic){(function(){e.node.setAttribute('controls',!0);e.node.setAttribute('id',e.node.getAttribute('id').replace('_'+o,'').replace('_from_mejs',''));var u=e.getElement(e.container).querySelector('.'+e.options.classPrefix+'poster>img');if(u){e.node.setAttribute('poster',u.src)};delete e.node.autoplay;e.node.setAttribute('src','');if(e.media.canPlayType((0,P.getTypeFromFile)(l))!==''){e.node.setAttribute('src',l)};if(o&&o.indexOf('iframe')>-1){var c=r.default.getElementById(e.media.id+'-iframe-overlay');c.remove()};var t=e.node.cloneNode();t.style.display='';e.getElement(e.container).parentNode.insertBefore(t,e.getElement(e.container));e.node.remove();if(e.mediaFiles){for(var n=0,f=e.mediaFiles.length;n<f;n++){var a=r.default.createElement('source');a.setAttribute('src',e.mediaFiles[n].src);a.setAttribute('type',e.mediaFiles[n].type);t.appendChild(a)}};if(e.trackFiles){var d=function(n,i){var o=e.trackFiles[n],a=r.default.createElement('track');a.kind=o.kind;a.label=o.label;a.srclang=o.srclang;a.src=o.src;t.appendChild(a);a.addEventListener('load',function(){this.mode='showing';t.textTracks[n].mode='showing'})};for(var i=0,s=e.trackFiles.length;i<s;i++){d(i,s)}};delete e.node;delete e.mediaFiles;delete e.trackFiles})()}
else{e.getElement(e.container).parentNode.insertBefore(e.node,e.getElement(e.container))};if(e.media.renderer&&typeof e.media.renderer.destroy==='function'){e.media.renderer.destroy()};delete s.default.players[e.id];if(p(e.getElement(e.container))==='object'){var u=e.getElement(e.container).parentNode.querySelector('.'+e.options.classPrefix+'offscreen');u.remove();e.getElement(e.container).remove()};e.globalUnbind('resize',e.globalResizeCallback);e.globalUnbind('keydown',e.globalKeydownCallback);e.globalUnbind('click',e.globalClickCallback);delete e.media.player}},{key:'paused',get:function(){return this.proxy.paused}},{key:'muted',get:function(){return this.proxy.muted},set:function(e){this.setMuted(e)}},{key:'ended',get:function(){return this.proxy.ended}},{key:'readyState',get:function(){return this.proxy.readyState}},{key:'currentTime',set:function(e){this.setCurrentTime(e)},get:function(){return this.getCurrentTime()}},{key:'duration',get:function(){return this.getDuration()}},{key:'volume',set:function(e){this.setVolume(e)},get:function(){return this.getVolume()}},{key:'src',set:function(e){this.setSrc(e)},get:function(){return this.getSrc()}}]);return e}();o.default.MediaElementPlayer=d;s.default.MediaElementPlayer=d;n.default=d},{'17':17,'2':2,'25':25,'26':26,'27':27,'28':28,'3':3,'30':30,'5':5,'6':6,'7':7}],17:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});var r=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1;n.configurable=!0;if('value' in n)n.writable=!0;Object.defineProperty(e,n.key,n)}};return function(t,n,i){if(n)e(t.prototype,n);if(i)e(t,i);return t}}(),a=e(3),o=s(a);function s(e){return e&&e.__esModule?e:{default:e}};function l(e,t){if(!(e instanceof t)){throw new TypeError('Cannot call a class as a function')}};var i=function(){function e(t){l(this,e);this.media=t.media;this.isVideo=t.isVideo;this.classPrefix=t.options.classPrefix;this.createIframeLayer=function(){return t.createIframeLayer()};this.setPoster=function(e){return t.setPoster(e)};return this};r(e,[{key:'play',value:function(){this.media.play()}},{key:'pause',value:function(){this.media.pause()}},{key:'load',value:function(){var e=this;if(!e.isLoaded){e.media.load()};e.isLoaded=!0}},{key:'setCurrentTime',value:function(e){this.media.setCurrentTime(e)}},{key:'getCurrentTime',value:function(){return this.media.currentTime}},{key:'getDuration',value:function(){var e=this.media.getDuration();if(e===Infinity&&this.media.seekable&&this.media.seekable.length){e=this.media.seekable.end(0)};return e}},{key:'setVolume',value:function(e){this.media.setVolume(e)}},{key:'getVolume',value:function(){return this.media.getVolume()}},{key:'setMuted',value:function(e){this.media.setMuted(e)}},{key:'setSrc',value:function(e){var t=this,n=document.getElementById(t.media.id+'-iframe-overlay');if(n){n.remove()};t.media.setSrc(e);t.createIframeLayer();if(t.media.renderer!==null&&typeof t.media.renderer.getPosterUrl==='function'){t.setPoster(t.media.renderer.getPosterUrl())}}},{key:'getSrc',value:function(){return this.media.getSrc()}},{key:'canPlayType',value:function(e){return this.media.canPlayType(e)}},{key:'paused',get:function(){return this.media.paused}},{key:'muted',set:function(e){this.setMuted(e)},get:function(){return this.media.muted}},{key:'ended',get:function(){return this.media.ended}},{key:'readyState',get:function(){return this.media.readyState}},{key:'currentTime',set:function(e){this.setCurrentTime(e)},get:function(){return this.getCurrentTime()}},{key:'duration',get:function(){return this.getDuration()}},{key:'remainingTime',get:function(){return this.getDuration()-this.currentTime()}},{key:'volume',set:function(e){this.setVolume(e)},get:function(){return this.getVolume()}},{key:'src',set:function(e){this.setSrc(e)},get:function(){return this.getSrc()}}]);return e}();n.default=i;o.default.DefaultPlayer=i},{'3':3}],18:[function(e,t,n){'use strict';var a=e(3),u=r(a),o=e(7),i=r(o),s=e(16),l=r(s);function r(e){return e&&e.__esModule?e:{default:e}};if(typeof jQuery!=='undefined'){i.default.$=jQuery}
else if(typeof Zepto!=='undefined'){i.default.$=Zepto}
else if(typeof ender!=='undefined'){i.default.$=ender}(function(e){if(typeof e!=='undefined'){e.fn.mediaelementplayer=function(t){if(t===!1){this.each(function(){var t=e(this).data('mediaelementplayer');if(t){t.remove()};e(this).removeData('mediaelementplayer')})}
else{this.each(function(){e(this).data('mediaelementplayer',new l.default(this,t))})};return this};e(document).ready(function(){e('.'+i.default.MepDefaults.classPrefix+'player').mediaelementplayer()})}})(i.default.$)},{'16':16,'3':3,'7':7}],19:[function(e,t,n){'use strict';var a=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(e){return typeof e}:function(e){return e&&typeof Symbol==='function'&&e.constructor===Symbol&&e!==Symbol.prototype?'symbol':typeof e},f=e(3),s=u(f),c=e(7),o=u(c),l=e(8),r=e(27),m=e(28),p=e(25),h=e(26);function u(e){return e&&e.__esModule?e:{default:e}};var i={promise:null,load:function(e){if(typeof dashjs!=='undefined'){i.promise=new Promise(function(e){e()}).then(function(){i._createPlayer(e)})}
else{e.options.path=typeof e.options.path==='string'?e.options.path:'https://cdn.dashjs.org/latest/dash.all.min.js';i.promise=i.promise||(0,h.loadScript)(e.options.path);i.promise.then(function(){i._createPlayer(e)})};return i.promise},_createPlayer:function(e){var t=dashjs.MediaPlayer().create();s.default['__ready__'+e.id](t);return t}};var d={name:'native_dash',options:{prefix:'native_dash',dash:{path:'https://cdn.dashjs.org/latest/dash.all.min.js',debug:!1,drm:{},robustnessLevel:''}},canPlayType:function(e){return p.HAS_MSE&&['application/dash+xml'].indexOf(e.toLowerCase())>-1},create:function(e,t,n){var f=e.originalNode,p=e.id+'_'+t.prefix,T=f.autoplay,E=f.children,u=null,d=null;f.removeAttribute('type');for(var g=0,P=E.length;g<P;g++){E[g].removeAttribute('type')};u=f.cloneNode(!0);t=Object.assign(t,e.options);var v=o.default.html5media.properties,m=o.default.html5media.events.concat(['click','mouseover','mouseout']).filter(function(e){return e!=='error'}),y=function(t){var n=(0,r.createEvent)(t.type,e);e.dispatchEvent(n)},w=function(e){var n=''+e.substring(0,1).toUpperCase()+e.substring(1);u['get'+n]=function(){return d!==null?u[e]:null};u['set'+n]=function(n){if(o.default.html5media.readOnlyProperties.indexOf(e)===-1){if(e==='src'){var l=(typeof n==='undefined'?'undefined':a(n))==='object'&&n.src?n.src:n;u[e]=l;if(d!==null){d.reset();for(var s=0,f=m.length;s<f;s++){u.removeEventListener(m[s],y)};d=i._createPlayer({options:t.dash,id:p});if(n&&(typeof n==='undefined'?'undefined':a(n))==='object'&&a(n.drm)==='object'){d.setProtectionData(n.drm);if((0,r.isString)(t.dash.robustnessLevel)&&t.dash.robustnessLevel){d.getProtectionController().setRobustnessLevel(t.dash.robustnessLevel)}};d.attachSource(l);if(T){d.play()}}}
else{u[e]=n}}}};for(var h=0,x=v.length;h<x;h++){w(v[h])};s.default['__ready__'+p]=function(n){e.dashPlayer=d=n;var s=dashjs.MediaPlayer.events,p=function(e){if(e==='loadedmetadata'){d.initialize();d.attachView(u);d.setAutoPlay(!1);if(a(t.dash.drm)==='object'&&!o.default.Utils.isObjectEmpty(t.dash.drm)){d.setProtectionData(t.dash.drm);if((0,r.isString)(t.dash.robustnessLevel)&&t.dash.robustnessLevel){d.getProtectionController().setRobustnessLevel(t.dash.robustnessLevel)}};d.attachSource(u.getSrc())};u.addEventListener(e,y)};for(var i=0,c=m.length;i<c;i++){p(m[i])};var f=function(t){if(t.type.toLowerCase()==='error'){e.generateError(t.message,u.src);console.error(t)}
else{var n=(0,r.createEvent)(t.type,e);n.data=t;e.dispatchEvent(n)}};for(var l in s){if(s.hasOwnProperty(l)){d.on(s[l],function(e){return f(e)})}}};if(n&&n.length>0){for(var c=0,S=n.length;c<S;c++){if(l.renderer.renderers[t.prefix].canPlayType(n[c].type)){u.setAttribute('src',n[c].src);if(typeof n[c].drm!=='undefined'){t.dash.drm=n[c].drm};break}}};u.setAttribute('id',p);f.parentNode.insertBefore(u,f);f.autoplay=!1;f.style.display='none';u.setSize=function(e,t){u.style.width=e+'px';u.style.height=t+'px';return u};u.hide=function(){u.pause();u.style.display='none';return u};u.show=function(){u.style.display='';return u};u.destroy=function(){if(d!==null){d.reset()}};var b=(0,r.createEvent)('rendererready',u);e.dispatchEvent(b);e.promises.push(i.load({options:t.dash,id:p}));return u}};m.typeChecks.push(function(e){return~e.toLowerCase().indexOf('.mpd')?'application/dash+xml':null});l.renderer.add(d)},{'25':25,'26':26,'27':27,'28':28,'3':3,'7':7,'8':8}],20:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});n.PluginDetector=undefined;var c=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(e){return typeof e}:function(e){return e&&typeof Symbol==='function'&&e.constructor===Symbol&&e!==Symbol.prototype?'symbol':typeof e},m=e(3),o=a(m),p=e(2),s=a(p),h=e(7),l=a(h),g=e(5),v=a(g),y=e(8),u=e(27),i=e(25),d=e(28);function a(e){return e&&e.__esModule?e:{default:e}};var r=n.PluginDetector={plugins:[],hasPluginVersion:function(e,t){var n=r.plugins[e];t[1]=t[1]||0;t[2]=t[2]||0;return n[0]>t[0]||n[0]===t[0]&&n[1]>t[1]||n[0]===t[0]&&n[1]===t[1]&&n[2]>=t[2]},addPlugin:function(e,t,n,i,a){r.plugins[e]=r.detectPlugin(t,n,i,a)},detectPlugin:function(e,t,n,r){var s=[0,0,0],u=void 0,d=void 0;if(i.NAV.plugins!==null&&i.NAV.plugins!==undefined&&c(i.NAV.plugins[e])==='object'){u=i.NAV.plugins[e].description;if(u&&!(typeof i.NAV.mimeTypes!=='undefined'&&i.NAV.mimeTypes[t]&&!i.NAV.mimeTypes[t].enabledPlugin)){s=u.replace(e,'').replace(/^\s+/,'').replace(/\sr/gi,'.').split('.');for(var l=0,f=s.length;l<f;l++){s[l]=parseInt(s[l].match(/\d+/),10)}}}
else if(o.default.ActiveXObject!==undefined){try{d=new ActiveXObject(n);if(d){s=r(d)}}catch(a){}};return s}};r.addPlugin('flash','Shockwave Flash','application/x-shockwave-flash','ShockwaveFlash.ShockwaveFlash',function(e){var n=[],t=e.GetVariable('$version');if(t){t=t.split(' ')[1].split(',');n=[parseInt(t[0],10),parseInt(t[1],10),parseInt(t[2],10)]};return n});var E={create:function(e,t,r){var n={};var x=!1;n.options=t;n.id=e.id+'_'+n.options.prefix;n.mediaElement=e;n.flashState={};n.flashApi=null;n.flashApiStack=[];var T=l.default.html5media.properties,j=function(e){n.flashState[e]=null;var t=''+e.substring(0,1).toUpperCase()+e.substring(1);n['get'+t]=function(){if(n.flashApi!==null){if(typeof n.flashApi['get_'+e]==='function'){var t=n.flashApi['get_'+e]();if(e==='buffered'){return{start:function(){return 0},end:function(){return t},length:1}};return t}
else{return null}}
...
else{return null}})}},{'2':2,'25':25,'27':27,'28':28,'3':3,'5':5,'7':7,'8':8}],21:[function(e,t,n){'use strict';var d=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(e){return typeof e}:function(e){return e&&typeof Symbol==='function'&&e.constructor===Symbol&&e!==Symbol.prototype?'symbol':typeof e},f=e(3),o=l(f),c=e(7),r=l(c),s=e(8),a=e(27),m=e(25),p=e(28),h=e(26);function l(e){return e&&e.__esModule?e:{default:e}};var i={promise:null,load:function(e){if(typeof flvjs!=='undefined'){i.promise=new Promise(function(e){e()}).then(function(){i._createPlayer(e)})}
else{e.options.path=typeof e.options.path==='string'?e.options.path:'https://cdn.jsdelivr.net/npm/flv.js@latest';i.promise=i.promise||(0,h.loadScript)(e.options.path);i.promise.then(function(){i._createPlayer(e)})};return i.promise},_createPlayer:function(e){flvjs.LoggingControl.enableDebug=e.options.debug;flvjs.LoggingControl.enableVerbose=e.options.debug;var t=flvjs.createPlayer(e.options,e.configs);o.default['__ready__'+e.id](t);return t}};var u={name:'native_flv',options:{prefix:'native_flv',flv:{path:'https://cdn.jsdelivr.net/npm/flv.js@latest',cors:!0,debug:!1}},canPlayType:function(e){return m.HAS_MSE&&['video/x-flv','video/flv'].indexOf(e.toLowerCase())>-1},create:function(e,t,n){var c=e.originalNode,h=e.id+'_'+t.prefix,l=null,u=null;l=c.cloneNode(!0);t=Object.assign(t,e.options);var v=r.default.html5media.properties,p=r.default.html5media.events.concat(['click','mouseover','mouseout']).filter(function(e){return e!=='error'}),y=function(t){var n=(0,a.createEvent)(t.type,e);e.dispatchEvent(n)},w=function(e){var n=''+e.substring(0,1).toUpperCase()+e.substring(1);l['get'+n]=function(){return u!==null?l[e]:null};l['set'+n]=function(n){if(r.default.html5media.readOnlyProperties.indexOf(e)===-1){if(e==='src'){l[e]=(typeof n==='undefined'?'undefined':d(n))==='object'&&n.src?n.src:n;if(u!==null){var a={};a.type='flv';a.url=n;a.cors=t.flv.cors;a.debug=t.flv.debug;a.path=t.flv.path;var f=t.flv.configs;u.destroy();for(var o=0,s=p.length;o<s;o++){l.removeEventListener(p[o],y)};u=i._createPlayer({options:a,configs:f,id:h});u.attachMediaElement(l);u.load()}}
else{l[e]=n}}}};for(var g=0,x=v.length;g<x;g++){w(v[g])};o.default['__ready__'+h]=function(t){e.flvPlayer=u=t;var n=flvjs.Events,f=function(e){if(e==='loadedmetadata'){u.unload();u.detachMediaElement();u.attachMediaElement(l);u.load()};l.addEventListener(e,y)};for(var i=0,d=p.length;i<d;i++){f(p[i])};var o=function(t,n){if(t==='error'){var r=n[0]+': '+n[1]+' '+n[2].msg;e.generateError(r,l.src)}
else{var i=(0,a.createEvent)(t,e);i.data=n;e.dispatchEvent(i)}},s=function(e){if(n.hasOwnProperty(e)){u.on(n[e],function(){for(var i=arguments.length,r=Array(i),t=0;t<i;t++){r[t]=arguments[t]};return o(n[e],r)})}};for(var r in n){s(r)}};if(n&&n.length>0){for(var m=0,S=n.length;m<S;m++){if(s.renderer.renderers[t.prefix].canPlayType(n[m].type)){l.setAttribute('src',n[m].src);break}}};l.setAttribute('id',h);c.parentNode.insertBefore(l,c);c.autoplay=!1;c.style.display='none';var f={};f.type='flv';f.url=l.src;f.cors=t.flv.cors;f.debug=t.flv.debug;f.path=t.flv.path;var b=t.flv.configs;l.setSize=function(e,t){l.style.width=e+'px';l.style.height=t+'px';return l};l.hide=function(){if(u!==null){u.pause()};l.style.display='none';return l};l.show=function(){l.style.display='';return l};l.destroy=function(){if(u!==null){u.destroy()}};var E=(0,a.createEvent)('rendererready',l);e.dispatchEvent(E);e.promises.push(i.load({options:f,configs:b,id:h}));return l}};p.typeChecks.push(function(e){return~e.toLowerCase().indexOf('.flv')?'video/flv':null});s.renderer.add(u)},{'25':25,'26':26,'27':27,'28':28,'3':3,'7':7,'8':8}],22:[function(e,t,n){'use strict';var d=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(e){return typeof e}:function(e){return e&&typeof Symbol==='function'&&e.constructor===Symbol&&e!==Symbol.prototype?'symbol':typeof e},f=e(3),o=l(f),c=e(7),r=l(c),s=e(8),a=e(27),m=e(25),p=e(28),h=e(26);function l(e){return e&&e.__esModule?e:{default:e}};var i={promise:null,load:function(e){if(typeof Hls!=='undefined'){i.promise=new Promise(function(e){e()}).then(function(){i._createPlayer(e)})}
else{e.options.path=typeof e.options.path==='string'?e.options.path:'https://cdn.jsdelivr.net/npm/hls.js@latest';i.promise=i.promise||(0,h.loadScript)(e.options.path);i.promise.then(function(){i._createPlayer(e)})};return i.promise},_createPlayer:function(e){var t=new Hls(e.options);o.default['__ready__'+e.id](t);return t}};var u={name:'native_hls',options:{prefix:'native_hls',hls:{path:'https://cdn.jsdelivr.net/npm/hls.js@latest',autoStartLoad:!1,debug:!1}},canPlayType:function(e){return m.HAS_MSE&&['application/x-mpegurl','application/vnd.apple.mpegurl','audio/mpegurl','audio/hls','video/hls'].indexOf(e.toLowerCase())>-1},create:function(e,t,n){var f=e.originalNode,p=e.id+'_'+t.prefix,g=f.getAttribute('preload'),b=f.autoplay,u=null,l=null,c=0,v=n.length;l=f.cloneNode(!0);t=Object.assign(t,e.options);t.hls.autoStartLoad=g&&g!=='none'||b;var y=r.default.html5media.properties,m=r.default.html5media.events.concat(['click','mouseover','mouseout']).filter(function(e){return e!=='error'}),E=function(t){var n=(0,a.createEvent)(t.type,e);e.dispatchEvent(n)},w=function(e){var n=''+e.substring(0,1).toUpperCase()+e.substring(1);l['get'+n]=function(){return u!==null?l[e]:null};l['set'+n]=function(n){if(r.default.html5media.readOnlyProperties.indexOf(e)===-1){if(e==='src'){l[e]=(typeof n==='undefined'?'undefined':d(n))==='object'&&n.src?n.src:n;if(u!==null){u.destroy();for(var a=0,o=m.length;a<o;a++){l.removeEventListener(m[a],E)};u=i._createPlayer({options:t.hls,id:p});u.loadSource(n);u.attachMedia(l)}}
else{l[e]=n}}}};for(var h=0,x=y.length;h<x;h++){w(y[h])};o.default['__ready__'+p]=function(t){e.hlsPlayer=u=t;var i=Hls.Events,g=function(t){if(t==='loadedmetadata'){var n=e.originalNode.src;u.detachMedia();u.loadSource(n);u.attachMedia(l)};l.addEventListener(t,E)};for(var s=0,h=m.length;s<h;s++){g(m[s])};var r=void 0,o=void 0,f=function(t,i){if(t==='hlsError'){console.warn(i);i=i[1];if(i.fatal){switch(i.type){case'mediaError':var p=new Date().getTime();if(!r||p-r>3000){r=new Date().getTime();u.recoverMediaError()}
...
else{r=e.originalNode};r.setAttribute('id',b);var p=i.default.html5media.properties,E=function(e){var t=''+e.substring(0,1).toUpperCase()+e.substring(1);r['get'+t]=function(){return r[e]};r['set'+t]=function(t){if(i.default.html5media.readOnlyProperties.indexOf(e)===-1){r[e]=t}}};for(var c=0,y=p.length;c<y;c++){E(p[c])};var m=i.default.html5media.events.concat(['click','mouseover','mouseout']).filter(function(e){return e!=='error'}),v=function(t){r.addEventListener(t,function(t){if(u){var n=(0,l.createEvent)(t.type,t.target);e.dispatchEvent(n)}})};for(var f=0,g=m.length;f<g;f++){v(m[f])};r.setSize=function(e,t){r.style.width=e+'px';r.style.height=t+'px';return r};r.hide=function(){u=!1;r.style.display='none';return r};r.show=function(){u=!0;r.style.display='';return r};var a=0,d=n.length;if(d>0){for(;a<d;a++){if(s.renderer.renderers[t.prefix].canPlayType(n[a].type)){r.setAttribute('src',n[a].src);break}}};r.addEventListener('error',function(t){if(t&&t.target&&t.target.error&&t.target.error.code===4&&u){if(a<d&&n[a+1]!==undefined){r.src=n[a++].src;r.load();r.play()}
else{e.generateError('Media error: Format(s) not supported or source(s) not found',n)}}});var h=(0,l.createEvent)('rendererready',r);e.dispatchEvent(h);return r}};f.default.HtmlMediaElement=i.default.HtmlMediaElement=a;s.renderer.add(a)},{'2':2,'25':25,'27':27,'3':3,'7':7,'8':8}],24:[function(e,t,n){'use strict';var u=e(3),o=a(u),d=e(2),f=a(d),c=e(7),s=a(c),m=e(8),r=e(27),p=e(28),h=e(26);function a(e){return e&&e.__esModule?e:{default:e}};var i={isIframeStarted:!1,isIframeLoaded:!1,iframeQueue:[],enqueueIframe:function(e){i.isLoaded=typeof YT!=='undefined'&&YT.loaded;if(i.isLoaded){i.createIframe(e)}
else{i.loadIframeApi();i.iframeQueue.push(e)}},loadIframeApi:function(){if(!i.isIframeStarted){(0,h.loadScript)('https://www.youtube.com/player_api');i.isIframeStarted=!0}},iFrameReady:function(){i.isLoaded=!0;i.isIframeLoaded=!0;while(i.iframeQueue.length>0){var e=i.iframeQueue.pop();i.createIframe(e)}},createIframe:function(e){return new YT.Player(e.containerId,e)},getYouTubeId:function(e){var t='';if(e.indexOf('?')>0){t=i.getYouTubeIdFromParam(e);if(t===''){t=i.getYouTubeIdFromUrl(e)}}
else{t=i.getYouTubeIdFromUrl(e)};var n=t.substring(t.lastIndexOf('/')+1);t=n.split('?');return t[0]},getYouTubeIdFromParam:function(e){if(e===undefined||e===null||!e.trim().length){return null};var o=e.split('?'),i=o[1].split('&'),r='';for(var t=0,a=i.length;t<a;t++){var n=i[t].split('=');if(n[0]==='v'){r=n[1];break}};return r},getYouTubeIdFromUrl:function(e){if(e===undefined||e===null||!e.trim().length){return null};var t=e.split('?');e=t[0];return e.substring(e.lastIndexOf('/')+1)},getYouTubeNoCookieUrl:function(e){if(e===undefined||e===null||!e.trim().length||e.indexOf('//www.youtube')===-1){return e};var t=e.split('/');t[2]=t[2].replace('.com','-nocookie.com');return t.join('/')}};var l={name:'youtube_iframe',options:{prefix:'youtube_iframe',youtube:{autoplay:0,controls:0,disablekb:1,end:0,loop:0,modestbranding:0,playsinline:0,rel:0,showinfo:0,start:0,iv_load_policy:3,nocookie:!1,imageQuality:null}},canPlayType:function(e){return~['video/youtube','video/x-youtube'].indexOf(e.toLowerCase())},create:function(e,t,n){var a={},p=[],L=4;var l=null,d=!0,c=!1,m=null,E=1;a.options=t;a.id=e.id+'_'+t.prefix;a.mediaElement=e;var S=s.default.html5media.properties,A=function(t){var n=''+t.substring(0,1).toUpperCase()+t.substring(1);a['get'+n]=function(){if(l!==null){var i=null;switch(t){case'currentTime':return l.getCurrentTime();case'duration':return l.getDuration();case'volume':E=l.getVolume()/100;return E;case'playbackRate':return l.getPlaybackRate();case'paused':return d;case'ended':return c;case'muted':return l.isMuted();case'buffered':var e=l.getVideoLoadedFraction(),n=l.getDuration();return{start:function(){return 0},end:function(){return e*n},length:1};case'src':return l.getVideoUrl();case'readyState':return L};return i}
...
else{l.unMute()};setTimeout(function(){var t=(0,r.createEvent)('volumechange',a);e.dispatchEvent(t)},50);break;case'volume':E=n;l.setVolume(n*100);setTimeout(function(){var t=(0,r.createEvent)('volumechange',a);e.dispatchEvent(t)},50);break;case'playbackRate':l.setPlaybackRate(n);setTimeout(function(){var t=(0,r.createEvent)('ratechange',a);e.dispatchEvent(t)},50);break;case'readyState':var s=(0,r.createEvent)('canplay',a);e.dispatchEvent(s);break;default:break}}
else{p.push({type:'set',propName:t,value:n})}}};for(var y=0,N=S.length;y<N;y++){A(S[y])};var b=s.default.html5media.methods,C=function(e){a[e]=function(){if(l!==null){switch(e){case'play':d=!1;return l.playVideo();case'pause':d=!0;return l.pauseVideo();case'load':return null}}
else{p.push({type:'call',methodName:e})}}};for(var v=0,k=b.length;v<k;v++){C(b[v])};var T=function(t){var i='';switch(t.data){case 2:i='The request contains an invalid parameter value. Verify that video ID has 11 characters and that contains no invalid characters, such as exclamation points or asterisks.';break;case 5:i='The requested content cannot be played in an HTML5 player or another error related to the HTML5 player has occurred.';break;case 100:i='The video requested was not found. Either video has been removed or has been marked as private.';break;case 101:case 105:i='The owner of the requested video does not allow it to be played in embedded players.';break;default:i='Unknown error.';break};e.generateError('Code '+t.data+': '+i,n)},g=f.default.createElement('div');g.id=a.id;if(a.options.youtube.nocookie){e.originalNode.src=i.getYouTubeNoCookieUrl(n[0].src)};e.originalNode.parentNode.insertBefore(g,e.originalNode);e.originalNode.style.display='none';var h=e.originalNode.tagName.toLowerCase()==='audio',x=h?'1':e.originalNode.height,w=h?'1':e.originalNode.width,P=i.getYouTubeId(n[0].src),u={id:a.id,containerId:g.id,videoId:P,height:x,width:w,playerVars:Object.assign({controls:0,rel:0,disablekb:1,showinfo:0,modestbranding:0,html5:1,iv_load_policy:3},a.options.youtube),origin:o.default.location.host,events:{onReady:function(t){e.youTubeApi=l=t.target;e.youTubeState={paused:!0,ended:!1};if(p.length){for(var s=0,E=p.length;s<E;s++){var n=p[s];if(n.type==='set'){var f=n.propName,y=''+f.substring(0,1).toUpperCase()+f.substring(1);a['set'+y](n.value)}
else if(n.type==='call'){a[n.methodName]()}}};m=l.getIframe();if(e.originalNode.muted){l.mute()};var d=['mouseover','mouseout'],v=function(t){var n=(0,r.createEvent)(t.type,a);e.dispatchEvent(n)};for(var o=0,g=d.length;o<g;o++){m.addEventListener(d[o],v,!1)};var u=['rendererready','loadedmetadata','loadeddata','canplay'];for(var i=0,h=u.length;i<h;i++){var c=(0,r.createEvent)(u[i],a);e.dispatchEvent(c)}},onStateChange:function(t){var n=[];switch(t.data){case-1:n=['loadedmetadata'];d=!0;c=!1;break;case 0:n=['ended'];d=!1;c=!a.options.youtube.loop;if(!a.options.youtube.loop){a.stopInterval()};break;case 1:n=['play','playing'];d=!1;c=!1;a.startInterval();break;case 2:n=['pause'];d=!0;c=!1;a.stopInterval();break;case 3:n=['progress'];c=!1;break;case 5:n=['loadeddata','loadedmetadata','canplay'];d=!0;c=!1;break};for(var i=0,s=n.length;i<s;i++){var o=(0,r.createEvent)(n[i],a);e.dispatchEvent(o)}},onError:function(e){return T(e)}}};if(h||e.originalNode.hasAttribute('playsinline')){u.playerVars.playsinline=1};if(e.originalNode.controls){u.playerVars.controls=1};if(e.originalNode.autoplay){u.playerVars.autoplay=1};if(e.originalNode.loop){u.playerVars.loop=1};if((u.playerVars.loop&&parseInt(u.playerVars.loop,10)===1||e.originalNode.src.indexOf('loop=')>-1)&&!u.playerVars.playlist&&e.originalNode.src.indexOf('playlist=')===-1){u.playerVars.playlist=i.getYouTubeId(e.originalNode.src)};i.enqueueIframe(u);a.onEvent=function(t,n,i){if(i!==null&&i!==undefined){e.youTubeState=i}};a.setSize=function(e,t){if(l!==null){l.setSize(e,t)}};a.hide=function(){a.stopInterval();a.pause();if(m){m.style.display='none'}};a.show=function(){if(m){m.style.display=''}};a.destroy=function(){l.destroy()};a.interval=null;a.startInterval=function(){a.interval=setInterval(function(){var t=(0,r.createEvent)('timeupdate',a);e.dispatchEvent(t)},250)};a.stopInterval=function(){if(a.interval){clearInterval(a.interval)}};a.getPosterUrl=function(){var n=t.youtube.imageQuality,a=['default','hqdefault','mqdefault','sddefault','maxresdefault'],r=i.getYouTubeId(e.originalNode.src);return n&&a.indexOf(n)>-1&&r?'https://img.youtube.com/vi/'+r+'/'+n+'.jpg':''};return a}};o.default.onYouTubePlayerAPIReady=function(){i.iFrameReady()};p.typeChecks.push(function(e){return(/\/\/(www\.youtube|youtu\.?be)/i.test(e)?'video/x-youtube':null)});m.renderer.add(l)},{'2':2,'26':26,'27':27,'28':28,'3':3,'7':7,'8':8}],25:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});n.cancelFullScreen=n.requestFullScreen=n.isFullScreen=n.FULLSCREEN_EVENT_NAME=n.HAS_NATIVE_FULLSCREEN_ENABLED=n.HAS_TRUE_NATIVE_FULLSCREEN=n.HAS_IOS_FULLSCREEN=n.HAS_MS_NATIVE_FULLSCREEN=n.HAS_MOZ_NATIVE_FULLSCREEN=n.HAS_WEBKIT_NATIVE_FULLSCREEN=n.HAS_NATIVE_FULLSCREEN=n.SUPPORTS_NATIVE_HLS=n.SUPPORT_PASSIVE_EVENT=n.SUPPORT_POINTER_EVENTS=n.HAS_MSE=n.IS_STOCK_ANDROID=n.IS_SAFARI=n.IS_FIREFOX=n.IS_CHROME=n.IS_EDGE=n.IS_IE=n.IS_ANDROID=n.IS_IOS=n.IS_IPOD=n.IS_IPHONE=n.IS_IPAD=n.UA=n.NAV=undefined;var Y=e(3),o=S(Y),K=e(2),r=S(K),G=e(7),i=S(G);function S(e){return e&&e.__esModule?e:{default:e}};var E=n.NAV=o.default.navigator,a=n.UA=E.userAgent.toLowerCase(),D=n.IS_IPAD=/ipad/i.test(a)&&!o.default.MSStream,R=n.IS_IPHONE=/iphone/i.test(a)&&!o.default.MSStream,V=n.IS_IPOD=/ipod/i.test(a)&&!o.default.MSStream,Q=n.IS_IOS=/ipad|iphone|ipod/i.test(a)&&!o.default.MSStream,H=n.IS_ANDROID=/android/i.test(a),w=n.IS_IE=/(trident|microsoft)/i.test(E.appName),U=n.IS_EDGE='msLaunchUri' in E&&!('documentMode' in r.default),b=n.IS_CHROME=/chrome/i.test(a),q=n.IS_FIREFOX=/firefox/i.test(a),P=n.IS_SAFARI=/safari/i.test(a)&&!b,B=n.IS_STOCK_ANDROID=/^mozilla\/\d+\.\d+\s\(linux;\su;/i.test(a),z=n.HAS_MSE='MediaSource' in o.default,W=n.SUPPORT_POINTER_EVENTS=function(){var e=r.default.createElement('x'),i=r.default.documentElement,t=o.default.getComputedStyle;if(!('pointerEvents' in e.style)){return!1};e.style.pointerEvents='auto';e.style.pointerEvents='x';i.appendChild(e);var n=t&&(t(e,'')||{}).pointerEvents==='auto';e.remove();return!!n}(),X=n.SUPPORT_PASSIVE_EVENT=function(){var t=!1;try{var n=Object.defineProperty({},'passive',{get:function(){t=!0}});o.default.addEventListener('test',null,n)}catch(e){};return t}(),T=['source','track','audio','video'],d=void 0;for(var y=0,O=T.length;y<O;y++){d=r.default.createElement(T[y])};var M=n.SUPPORTS_NATIVE_HLS=P||w&&/edge/i.test(a),c=d.webkitEnterFullscreen!==undefined,x=d.requestFullscreen!==undefined;if(c&&/mac os x 10_5/i.test(a)){x=!1;c=!1};var u=d.webkitRequestFullScreen!==undefined,s=d.mozRequestFullScreen!==undefined,l=d.msRequestFullscreen!==undefined,m=u||s||l,p=m,f='',h=void 0,g=void 0,v=void 0;if(s){p=r.default.mozFullScreenEnabled}
else if(l){p=r.default.msFullscreenEnabled};if(b){c=!1};if(m){if(u){f='webkitfullscreenchange'}
else if(s){f='fullscreenchange'}
...
else if(l){return r.default.msFullscreenElement!==null}};n.requestFullScreen=g=function(e){if(u){e.webkitRequestFullScreen()}
else if(s){e.mozRequestFullScreen()}
else if(l){e.msRequestFullscreen()}};n.cancelFullScreen=v=function(){if(u){r.default.webkitCancelFullScreen()}
else if(s){r.default.mozCancelFullScreen()}
else if(l){r.default.msExitFullscreen()}}};var k=n.HAS_NATIVE_FULLSCREEN=x,C=n.HAS_WEBKIT_NATIVE_FULLSCREEN=u,N=n.HAS_MOZ_NATIVE_FULLSCREEN=s,A=n.HAS_MS_NATIVE_FULLSCREEN=l,L=n.HAS_IOS_FULLSCREEN=c,F=n.HAS_TRUE_NATIVE_FULLSCREEN=m,I=n.HAS_NATIVE_FULLSCREEN_ENABLED=p,j=n.FULLSCREEN_EVENT_NAME=f;n.isFullScreen=h;n.requestFullScreen=g;n.cancelFullScreen=v;i.default.Features=i.default.Features||{};i.default.Features.isiPad=D;i.default.Features.isiPod=V;i.default.Features.isiPhone=R;i.default.Features.isiOS=i.default.Features.isiPhone||i.default.Features.isiPad;i.default.Features.isAndroid=H;i.default.Features.isIE=w;i.default.Features.isEdge=U;i.default.Features.isChrome=b;i.default.Features.isFirefox=q;i.default.Features.isSafari=P;i.default.Features.isStockAndroid=B;i.default.Features.hasMSE=z;i.default.Features.supportsNativeHLS=M;i.default.Features.supportsPointerEvents=W;i.default.Features.supportsPassiveEvent=X;i.default.Features.hasiOSFullScreen=L;i.default.Features.hasNativeFullscreen=k;i.default.Features.hasWebkitNativeFullScreen=C;i.default.Features.hasMozNativeFullScreen=N;i.default.Features.hasMsNativeFullScreen=A;i.default.Features.hasTrueNativeFullScreen=F;i.default.Features.nativeFullScreenEnabled=I;i.default.Features.fullScreenEventName=j;i.default.Features.isFullScreen=h;i.default.Features.requestFullScreen=g;i.default.Features.cancelFullScreen=v},{'2':2,'3':3,'7':7}],26:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});n.removeClass=n.addClass=n.hasClass=undefined;n.loadScript=m;n.offset=p;n.toggleClass=h;n.fadeOut=g;n.fadeIn=v;n.siblings=y;n.visible=E;n.ajax=b;var S=e(3),r=d(S),x=e(2),a=d(x),w=e(7),i=d(w);function d(e){return e&&e.__esModule?e:{default:e}};function m(e){return new Promise(function(t,n){var i=a.default.createElement('script');i.src=e;i.async=!0;i.onload=function(){i.remove();t()};i.onerror=function(){i.remove();n()};a.default.head.appendChild(i)})};function p(e){var t=e.getBoundingClientRect(),n=r.default.pageXOffset||a.default.documentElement.scrollLeft,i=r.default.pageYOffset||a.default.documentElement.scrollTop;return{top:t.top+i,left:t.left+n}};var s=void 0,l=void 0,u=void 0;if('classList' in a.default.documentElement){s=function(e,t){return e.classList!==undefined&&e.classList.contains(t)};l=function(e,t){return e.classList.add(t)};u=function(e,t){return e.classList.remove(t)}}
else{s=function(e,t){return new RegExp('\\b'+t+'\\b').test(e.className)};l=function(e,t){if(!o(e,t)){e.className+=' '+t}};u=function(e,t){e.className=e.className.replace(new RegExp('\\b'+t+'\\b','g'),'')}};var o=n.hasClass=s,f=n.addClass=l,c=n.removeClass=u;function h(e,t){o(e,t)?c(e,t):f(e,t)};function g(e){var i=arguments.length>1&&arguments[1]!==undefined?arguments[1]:400,n=arguments[2];if(!e.style.opacity){e.style.opacity=1};var t=null;r.default.requestAnimationFrame(function a(o){t=t||o;var s=o-t,l=parseFloat(1-s/i,2);e.style.opacity=l<0?0:l;if(s>i){if(n&&typeof n==='function'){n()}}
...
while(t<0&&(n=n.parentElement));return n}}(function(){var n=0,t=['ms','moz','webkit','o'];for(var e=0;e<t.length&&!window.requestAnimationFrame;++e){window.requestAnimationFrame=window[t[e]+'RequestAnimationFrame'];window.cancelAnimationFrame=window[t[e]+'CancelAnimationFrame']||window[t[e]+'CancelRequestAnimationFrame']};if(!window.requestAnimationFrame)window.requestAnimationFrame=function(e){var t=new Date().getTime(),i=Math.max(0,16-(t-n)),r=window.setTimeout(function(){e(t+i)},i);n=t+i;return r};if(!window.cancelAnimationFrame)window.cancelAnimationFrame=function(e){clearTimeout(e)}})();if(/firefox/i.test(navigator.userAgent)){var r=window.getComputedStyle;window.getComputedStyle=function(e,t){var n=r(e,t);return n===null?{getPropertyValue:function(){}}:n}};if(!window.Promise){window.Promise=l.default}(function(e){if(e&&e.prototype&&e.prototype.children===null){Object.defineProperty(e.prototype,'children',{get:function(){var n=0,e=void 0,i=this.childNodes,t=[];while(e=i[n++]){if(e.nodeType===1){t.push(e)}};return t}})}})(window.Node||window.Element)},{'2':2,'4':4}],30:[function(e,t,n){'use strict';Object.defineProperty(n,'__esModule',{value:!0});n.isDropFrame=r;n.secondsToTimeCode=a;n.timeCodeToSeconds=o;n.calculateTimeFormat=s;n.convertSMPTEtoSeconds=l;var u=e(7),i=d(u);function d(e){return e&&e.__esModule?e:{default:e}};function r(){var e=arguments.length>0&&arguments[0]!==undefined?arguments[0]:25;return!(e%1===0)};function a(e){var k=arguments.length>1&&arguments[1]!==undefined?arguments[1]:!1,v=arguments.length>2&&arguments[2]!==undefined?arguments[2]:!1,s=arguments.length>3&&arguments[3]!==undefined?arguments[3]:25,x=arguments.length>4&&arguments[4]!==undefined?arguments[4]:0,C=arguments.length>5&&arguments[5]!==undefined?arguments[5]:'hh:mm:ss';e=!e||typeof e!=='number'||e<0?0:e;var f=Math.round(s*0.066666),h=Math.round(s),E=Math.round(s*3600)*24,b=Math.round(s*600),S=r(s)?';':':',a=void 0,i=void 0,n=void 0,o=void 0,t=Math.round(e*s);if(r(s)){if(t<0){t=E+t};t=t%E;var T=Math.floor(t/b),y=t%b;t=t+f*9*T;if(y>f){t=t+f*Math.floor((y-f)/Math.round(h*60-f))};var g=Math.floor(t/h);a=Math.floor(Math.floor(g/60)/60);i=Math.floor(g/60)%60;if(v){n=g%60}
else{n=Math.floor(t/h%60).toFixed(x)}}
else{a=Math.floor(e/3600)%24;i=Math.floor(e/60)%60;if(v){n=Math.floor(e%60)}
else{n=Math.floor(e%60).toFixed(x)}};a=a<=0?0:a;i=i<=0?0:i;n=n<=0?0:n;n=n===60?0:n;i=i===60?0:i;var u=C.split(':'),d={};for(var l=0,P=u.length;l<P;++l){var p='';for(var m=0,w=u[l].length;m<w;m++){if(p.indexOf(u[l][m])<0){p+=u[l][m]}};if(~['f','s','m','h'].indexOf(p)){d[p]=u[l].length}};var c=k||a>0?(a<10&&d.h>1?'0'+a:a)+':':'';c+=(i<10&&d.m>1?'0'+i:i)+':';c+=''+(n<10&&d.s>1?'0'+n:n);if(v){o=(t%h).toFixed(0);o=o<=0?0:o;c+=o<10&&d.f?S+'0'+o:''+S+o};return c};function o(e){var o=arguments.length>1&&arguments[1]!==undefined?arguments[1]:25;if(typeof e!=='string'){throw new TypeError('Time must be a string')};if(e.indexOf(';')>0){e=e.replace(';',':')};if(!/\d{2}(\:\d{2}){0,3}/i.test(e)){throw new TypeError('Time code must have the format `00:00:00`')};var t=e.split(':'),s=void 0,a=0,n=0,i=0,l=0,u=0,m=Math.round(o*0.066666),d=Math.round(o),f=d*3600,c=d*60;switch(t.length){default:case 1:i=parseInt(t[0],10);break;case 2:n=parseInt(t[0],10);i=parseInt(t[1],10);break;case 3:a=parseInt(t[0],10);n=parseInt(t[1],10);i=parseInt(t[2],10);break;case 4:a=parseInt(t[0],10);n=parseInt(t[1],10);i=parseInt(t[2],10);l=parseInt(t[3],10);break};if(r(o)){u=60*a+n;s=f*a+c*n+d*i+l-m*(u-Math.floor(u/10))}
else{s=(f*a+c*n+o*i+l)/o};return parseFloat(s.toFixed(3))};function s(e,t){var v=arguments.length>2&&arguments[2]!==undefined?arguments[2]:25;e=!e||typeof e!=='number'||e<0?0:e;var c=Math.floor(e/3600)%24,m=Math.floor(e/60)%60,p=Math.floor(e%60),h=Math.floor((e%1*v).toFixed(3)),r=[[h,'f'],[p,'s'],[m,'m'],[c,'h']],n=t.timeFormat,o=n[1]===n[0],u=o?2:1,g=n.length<u?n[u]:':',d=n[0],f=!1;for(var i=0,l=r.length;i<l;i++){if(~n.indexOf(r[i][1])){f=!0}
else if(f){var s=!1;for(var a=i;a<l;a++){if(r[a][0]>0){s=!0;break}};if(!s){break};if(!o){n=d+n};n=r[i][1]+g+n;if(o){n=r[i][1]+n};d=r[i][1]}};t.timeFormat=n};function l(e){if(typeof e!=='string'){throw new TypeError('Argument must be a string value')};e=e.replace(',','.');var a=~e.indexOf('.')?e.split('.')[1].length:0,i=0,n=1;e=e.split(':').reverse();for(var t=0,r=e.length;t<r;t++){n=1;if(t>0){n=Math.pow(60,t)};i+=Number(e[t])*n};return Number(i.toFixed(a))};i.default.Utils=i.default.Utils||{};i.default.Utils.secondsToTimeCode=a;i.default.Utils.timeCodeToSeconds=o;i.default.Utils.calculateTimeFormat=s;i.default.Utils.convertSMPTEtoSeconds=l},{'7':7}]},{},[29,6,5,15,23,20,19,21,22,24,16,18,17,9,10,11,12,13,14]);